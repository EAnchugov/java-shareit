...
CREATE TABLE IF NOT EXISTS requests (
                                        ...
                                        CONSTRAINT fk_item_сomment FOREIGN KEY (id) REFERENCES items ON DELETE CASCADE,
                                        CONSTRAINT fk_user_сomment FOREIGN KEY (id) REFERENCES users ON DELETE CASCADE
);